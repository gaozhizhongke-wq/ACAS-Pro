...
class QQOAuth(OAuthProvider):
    ...
    @property
    def APP_ID(self):
        return self._cfg.qq_app_id

    @property
    def APP_KEY(self):
        return self._cfg.qq_app_key

    @property
    def REDIRECT_URI(self):
        return self._cfg.qq_redirect_uri
...
class WeChatOAuth(OAuthProvider):
    ...
    @property
    def APP_ID(self):
        return self._cfg.wechat_app_id

    @property
    def APP_SECRET(self):
        return self._cfg.wechat_app_secret

    @property
    def REDIRECT_URI(self):
        return self._cfg.wechat_redirect_uri
...
class OAuthService:
    ...
    def handle_callback(self, provider: str, code: str) -> Optional[OAuthUserInfo]:
        ...
        user_info = provider_obj.get_user_info(
            token_resp.access_token, token_resp.openid or ""
        )
        if not user_info:
