...
class DouyinShopClient(PlatformAPIClient):
    ...
    def sync_orders(
        ...
        try:
            ...
            logger.exception(f"[抖音小店] Order sync failed")
    ...
    def sync_products(
        ...
        try:
            ...
            logger.exception(f"[抖音小店] Product sync failed")
            return SyncResult(success=False, errors=[str(e)])
    ...
    def sync_inventory(
        ...
        try:
            ...
            logger.exception(f"[抖音小店] Inventory sync failed")
            return SyncResult(success=False, errors=[str(e)])
    ...
    def update_product_status(self, product_id: str, status: str) -> bool:
        ...
        try:
            ...
            logger.exception(f"[抖音小店] Update product status failed")
            return False
    ...
    def get_logistics_info(self, order_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"[抖音小店] Logistics query failed")
            return {"error": str(e)}
    ...
    def exchange_token(self, code: str) -> Dict[str, str]:
        ...
        try:
            ...
            logger.exception(f"[抖音小店] Token exchange failed")
            return {"error": str(e)}
