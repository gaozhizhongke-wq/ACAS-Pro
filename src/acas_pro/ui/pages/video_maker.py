...
class VideoMakerPage(QWidget):
    ...
    def _create_projects_tab(self) -> QWidget:
        ...
        self.platform_filter.addItems(["全部", "抖音", "小红书", "快手", "B站", "TikTok"])
    ...
    def _load_projects(self):
        ...
        for project in projects:
            ...
            platform_name = platform_names.get(project.target_platform, project.target_platform)
    ...
    def _create_new_project(self):
        ...
        ok_btn.setStyleSheet(f"background-color: {COLORS['accent']}; color: white; padding: 8px 16px;")
        ...
        if dialog.exec() == QDialog.Accepted:
            ...
            project = self.video_maker.create_project(
                ...
                target_platform=platform_map.get(platform_input.currentText(), "douyin"),
    ...
    def _generate_voice(self):
        ...
        if output_path:
            QMessageBox.information(self, "成功", f"配音生成完成！\n保存位置: {output_path}")
        else:
