...
class AddAccountDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        self.platform_combo.addItems(["抖音", "小红书", "快手", "B站", "TikTok", "Instagram", "YouTube"])
...
class AccountManagementPage(QWidget):
    ...
    def _setup_ui(self):
        ...
        for title_text, value, color in [
            ...
            ("总粉丝数", f"{(summary.get('total_followers') or 0)/10000:.1f}万", COLORS['warning']),
        ]:
            card = QFrame()
        ...
        self.platform_filter.addItems(["全部平台", "抖音", "小红书", "快手", "B站", "TikTok", "Instagram", "YouTube"])
    ...
    def _on_account_added(self, data: dict):
        ...
        try:
            ...
            QMessageBox.information(self, "添加成功", f"账号 {account.nickname} 添加成功！")
            self._load_accounts()
