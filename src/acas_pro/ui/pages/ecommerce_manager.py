...
from ...ecommerce.shop_manager import (
    ShopManager,
    Shop,
    ShopPlatform,
    ShopStatus,
...
from ...ecommerce.supply_chain import SupplyChainManager
    ...
    def load_shops(self) -> None:
        ...
        demo_shops = [
            Shop(
                ...
                stats=ShopStats(
                    total_products=128, total_orders_today=45, revenue_today=5680.0
                ),
            ),
            Shop(
                id="shop_2",
                ...
                status=ShopStatus.ACTIVE,
                stats=ShopStats(
                    total_products=96, total_orders_today=32, revenue_today=4230.0
                ),
            ),
        ]
