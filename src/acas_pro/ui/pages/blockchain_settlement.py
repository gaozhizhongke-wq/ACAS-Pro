...
from ...blockchain.settlement_engine import (
    SettlementEngine, SettlementRecord, SettlementStatus, SettlementParty
)
from ...blockchain.wallet_manager import WalletManager, Wallet, Transaction, TransactionType
...
class WalletCard(QFrame):
    ...
    def setup_ui(self):
        ...
        address.setStyleSheet("color: #8b949e; font-size: 11px; font-family: monospace;")
        ...
        for currency, amount in self.wallet.balances.items():
            if amount > 0:
                ...
                amount_label.setStyleSheet("color: #c9d1d9; font-size: 18px; font-weight: bold;")
...
class SettlementCard(QFrame):
    ...
    def setup_ui(self):
        ...
        id_label.setStyleSheet("color: #8b949e; font-size: 11px; font-family: monospace;")
        ...
        # 金额
        amount = QLabel(f"{self.settlement.total_amount:,.2f} {self.settlement.currency}")
...
class BlockchainSettlementPage(QWidget):
    ...
    def _create_new_settlement_tab(self) -> QWidget:
        ...
        self.parties_table.setHorizontalHeaderLabels(["名称", "类型", "钱包地址", "分成比例%"])
    ...
    def load_settlements(self):
        ...
        demo_settlements = [
            SettlementRecord(
                ...
                total_amount=5000,
                parties=[
                    SettlementParty("platform", "platform", "平台", share_percentage=30),
                    SettlementParty("creator", "creator", "创作者", share_percentage=50),
                    SettlementParty("affiliate", "affiliate", "推广者", share_percentage=20),
                ],
            ...
            SettlementRecord(
                ...
                total_amount=10000,
                parties=[
                    SettlementParty("platform", "platform", "平台", share_percentage=20),
                    SettlementParty("advertiser", "advertiser", "广告主", share_percentage=70),
    ...
    def load_transactions(self):
        ...
        # 模拟数据
        demo_txs = [
            ("tx_001", "转账", "1,000.00 USDT", "1.00 USDT", "已完成", "2024-12-01 10:30"),
            ("tx_002", "结算", "5,000.00 USDT", "2.00 USDT", "已完成", "2024-12-01 09:15"),
            ("tx_003", "充值", "10,000.00 USDT", "0.00 USDT", "已完成", "2024-11-30 18:45"),
        ]
