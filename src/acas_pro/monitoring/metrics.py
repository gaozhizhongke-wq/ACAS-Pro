...
try:
    ...
    def generate_latest(*args): return b'prometheus not installed'
...
QUEUE_JOBS = Counter('acas_queue_jobs_total', 'Total queue jobs', ['queue_name', 'status'])
